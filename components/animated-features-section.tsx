      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Transparent quantum-safe migration for EU banking infrastructure. Zero code changes required.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
          <div className="md:col-span-2">
            <BentoCard
              title="CBOM Scanner"
              value="Build-Time Inspector"
              subtitle="Automatic cryptography inventory with CycloneDX 1.6 compliance. Scans source code, binaries, and container images for crypto assets."
          ...
          <BentoCard
            ...
            value="Q-Hook"
            subtitle="LD_PRELOAD injection upgrades RSA to ML-KEM transparently"
            colors={["#151515", "#252525", "#1d1d1d"]}
            delay={0.4}
          />
          <BentoCard
            title="Migration Uptime"
            value="99.95%"
            subtitle="Zero downtime crypto migration"
          ...
          <div className="md:col-span-2">
            <BentoCard
              ...
              subtitle="Full CNCF stack integration with Prometheus metrics, Grafana dashboards, and OPA policy enforcement"
          ...
          <div className="md:col-span-3">
            <BentoCard
              title="Hybrid Crypto Mode"
              value="X25519 + Kyber-1024"
              subtitle="Backward-compatible quantum-safe encryption. Classical fallback for non-PQC recipients. NIST FIPS 203/204/205 compliant."
